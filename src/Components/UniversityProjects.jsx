...
const UniversityProjects = () => {
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <h2 className="text-5xl font-bold text-center mb-12 py-6 leading-tight bg-gradient-to-r from-blue-500 to-purple-500 bg-clip-text text-transparent sm:text-white">
        University Projects
      </h2>
